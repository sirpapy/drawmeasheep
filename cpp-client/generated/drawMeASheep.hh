...
#ifndef __drawMeASheep_mDrawing__
#define __drawMeASheep_mDrawing__
  ...
  public:
    ...
    void centralSymetric(const ::drawMeASheep::Point& p);
    void axialSymetric(const ::drawMeASheep::Point& p1, const ::drawMeASheep::Point& p2);
  ...
  public:
    ...
    virtual void centralSymetric(const ::drawMeASheep::Point& p) = 0;
    virtual void axialSymetric(const ::drawMeASheep::Point& p1, const ::drawMeASheep::Point& p2) = 0;
...
#ifndef __drawMeASheep_mPolygone__
#define __drawMeASheep_mPolygone__
...
#ifndef __drawMeASheep_mLine__
#define __drawMeASheep_mLine__
...
#ifndef __drawMeASheep_mCercle__
#define __drawMeASheep_mCercle__
...
#ifndef __drawMeASheep_mEllipse__
#define __drawMeASheep_mEllipse__
...
#ifndef __drawMeASheep_mDrawingGroup__
#define __drawMeASheep_mDrawingGroup__
...
#ifndef __drawMeASheep_mDrawingManager__
#define __drawMeASheep_mDrawingManager__
  ...
  {
  public:
    ::CORBA::Boolean add(::drawMeASheep::Drawing_ptr d);
    ::CORBA::Boolean isFull();
    ::CORBA::Double getAvailableSurgace();
    DrawingMap* map();
  ...
  public:
    ...
    virtual ::CORBA::Boolean add(::drawMeASheep::Drawing_ptr d) = 0;
    virtual ::CORBA::Boolean isFull() = 0;
    virtual ::CORBA::Double getAvailableSurgace() = 0;
    virtual DrawingMap* map() = 0;
...
_CORBA_MODULE_BEG
  ...
  class Drawing :
    public virtual drawMeASheep::_impl_Drawing,
    public virtual ::PortableServer::ServantBase
  {
  public:
    virtual ~Drawing();

    inline ::drawMeASheep::Drawing_ptr _this() {
      return (::drawMeASheep::Drawing_ptr) _do_this(::drawMeASheep::Drawing::_PD_repoId);
    }
  };

  class Polygone :
    public virtual drawMeASheep::_impl_Polygone,
    public virtual Drawing
  {
  public:
    virtual ~Polygone();

    inline ::drawMeASheep::Polygone_ptr _this() {
      return (::drawMeASheep::Polygone_ptr) _do_this(::drawMeASheep::Polygone::_PD_repoId);
    }
  };

  class Line :
    public virtual drawMeASheep::_impl_Line,
    public virtual Drawing
  {
  public:
    virtual ~Line();

    inline ::drawMeASheep::Line_ptr _this() {
      return (::drawMeASheep::Line_ptr) _do_this(::drawMeASheep::Line::_PD_repoId);
    }
  };

  class Cercle :
    public virtual drawMeASheep::_impl_Cercle,
    public virtual Drawing
  {
  public:
    virtual ~Cercle();

    inline ::drawMeASheep::Cercle_ptr _this() {
      return (::drawMeASheep::Cercle_ptr) _do_this(::drawMeASheep::Cercle::_PD_repoId);
    }
  };

  class Ellipse :
    public virtual drawMeASheep::_impl_Ellipse,
    public virtual Drawing
  {
  public:
    virtual ~Ellipse();

    inline ::drawMeASheep::Ellipse_ptr _this() {
      return (::drawMeASheep::Ellipse_ptr) _do_this(::drawMeASheep::Ellipse::_PD_repoId);
    }
  };

  class DrawingGroup :
    public virtual drawMeASheep::_impl_DrawingGroup,
    public virtual Drawing
  {
  public:
    virtual ~DrawingGroup();

    inline ::drawMeASheep::DrawingGroup_ptr _this() {
      return (::drawMeASheep::DrawingGroup_ptr) _do_this(::drawMeASheep::DrawingGroup::_PD_repoId);
    }
  };

  class DrawingManager :
    public virtual drawMeASheep::_impl_DrawingManager,
    public virtual ::PortableServer::ServantBase
  {
  public:
    virtual ~DrawingManager();

    inline ::drawMeASheep::DrawingManager_ptr _this() {
      return (::drawMeASheep::DrawingManager_ptr) _do_this(::drawMeASheep::DrawingManager::_PD_repoId);
    }
  };
...
inline void
drawMeASheep::Drawing::_marshalObjRef(::drawMeASheep::Drawing_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}


inline void
drawMeASheep::Polygone::_marshalObjRef(::drawMeASheep::Polygone_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}


inline void
drawMeASheep::Line::_marshalObjRef(::drawMeASheep::Line_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}


inline void
drawMeASheep::Cercle::_marshalObjRef(::drawMeASheep::Cercle_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}


inline void
drawMeASheep::Ellipse::_marshalObjRef(::drawMeASheep::Ellipse_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}


inline void
drawMeASheep::DrawingGroup::_marshalObjRef(::drawMeASheep::DrawingGroup_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}


inline void
drawMeASheep::DrawingManager::_marshalObjRef(::drawMeASheep::DrawingManager_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}

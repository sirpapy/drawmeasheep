...
#ifndef __entity_mDrawing__
#define __entity_mDrawing__
  class Drawing;
  ...
  public:
    ...
    void centralSymetric(const ::entity::Point& p);
    void axialSymetric(const ::entity::Point& p1, const ::entity::Point& p2);
  ...
  public:
    ...
    virtual void centralSymetric(const ::entity::Point& p) = 0;
    virtual void axialSymetric(const ::entity::Point& p1, const ::entity::Point& p2) = 0;
...
#ifndef __entity_mPolygone__
#define __entity_mPolygone__
  class Polygone;
...
#ifndef __entity_mLine__
#define __entity_mLine__
  class Line;
  class _objref_Line;
  class _impl_Line;
...
#ifndef __entity_mCercle__
#define __entity_mCercle__
  class Cercle;
...
#ifndef __entity_mEllipse__
#define __entity_mEllipse__
  class Ellipse;
...
#ifndef __entity_mDrawingGroup__
#define __entity_mDrawingGroup__
  class DrawingGroup;
...
#ifndef __manager_mDrawingManager__
#define __manager_mDrawingManager__
  ...
  public:
    ...
    virtual ::CORBA::Any* createDrawing(const char* name, const ::entity::PointSet& points, ::CORBA::Double rayon) = 0;
...
_CORBA_MODULE POA_entity
_CORBA_MODULE_BEG

  class Drawing :
    public virtual entity::_impl_Drawing,
    public virtual ::PortableServer::ServantBase
  {
  public:
    virtual ~Drawing();

    inline ::entity::Drawing_ptr _this() {
      return (::entity::Drawing_ptr) _do_this(::entity::Drawing::_PD_repoId);
    }
  };

  class Polygone :
    public virtual entity::_impl_Polygone,
    public virtual Drawing
  {
  public:
    virtual ~Polygone();

    inline ::entity::Polygone_ptr _this() {
      return (::entity::Polygone_ptr) _do_this(::entity::Polygone::_PD_repoId);
    }
  };

  class Line :
    public virtual entity::_impl_Line,
    public virtual Drawing
  {
  public:
    virtual ~Line();

    inline ::entity::Line_ptr _this() {
      return (::entity::Line_ptr) _do_this(::entity::Line::_PD_repoId);
    }
  };

  class Cercle :
    public virtual entity::_impl_Cercle,
    public virtual Drawing
  {
  public:
    virtual ~Cercle();

    inline ::entity::Cercle_ptr _this() {
      return (::entity::Cercle_ptr) _do_this(::entity::Cercle::_PD_repoId);
    }
  };

  class Ellipse :
    public virtual entity::_impl_Ellipse,
    public virtual Drawing
  {
  public:
    virtual ~Ellipse();

    inline ::entity::Ellipse_ptr _this() {
      return (::entity::Ellipse_ptr) _do_this(::entity::Ellipse::_PD_repoId);
    }
  };

  class DrawingGroup :
    public virtual entity::_impl_DrawingGroup,
    public virtual Drawing
  {
  public:
    virtual ~DrawingGroup();

    inline ::entity::DrawingGroup_ptr _this() {
      return (::entity::DrawingGroup_ptr) _do_this(::entity::DrawingGroup::_PD_repoId);
    }
  };

_CORBA_MODULE_END

_CORBA_MODULE POA_manager
_CORBA_MODULE_BEG

  class DrawingManager :
    public virtual manager::_impl_DrawingManager,
    public virtual ::PortableServer::ServantBase
  {
  public:
    virtual ~DrawingManager();

    inline ::manager::DrawingManager_ptr _this() {
      return (::manager::DrawingManager_ptr) _do_this(::manager::DrawingManager::_PD_repoId);
    }
  };
...
_CORBA_MODULE OBV_entity
_CORBA_MODULE_BEG

_CORBA_MODULE_END

_CORBA_MODULE OBV_manager
_CORBA_MODULE_BEG
...
inline void
entity::Drawing::_marshalObjRef(::entity::Drawing_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}

inline void
entity::Polygone::_marshalObjRef(::entity::Polygone_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}

inline void
entity::Line::_marshalObjRef(::entity::Line_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}

inline void
entity::Cercle::_marshalObjRef(::entity::Cercle_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}

inline void
entity::Ellipse::_marshalObjRef(::entity::Ellipse_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}

inline void
entity::DrawingGroup::_marshalObjRef(::entity::DrawingGroup_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}

inline void
manager::DrawingManager::_marshalObjRef(::manager::DrawingManager_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}
